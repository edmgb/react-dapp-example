...
import { Spinner, FormControl, Input, Button, Box, Divider, Heading, Text, Flex, Link } from "@chakra-ui/react";
import { ExternalLinkIcon } from "@chakra-ui/icons";
import Greeter from "./artifacts/contracts/Greeter.sol/Greeter.json";
import "./App.css";

const greeterAddress = "0x693F885F0CF1adDDD801a252B909AB91Bfd23B4f";
              ...
              <Box w="80%" p={3}>
                ...
                <Text color="gray.500" isTruncated m={12} as="kbd">
                  {contractAddress && (
                      <>
                        <br /> Contract Address:
                        <Link href={`https://ropsten.etherscan.io/address/${contractAddress}`} isExternal>
                          {" "}
                          {contractAddress} <ExternalLinkIcon mx="12px" />
                        </Link>
                      </>
                  )}
                </Text>
